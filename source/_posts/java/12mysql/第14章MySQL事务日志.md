...
![](./img/20203/07/mysql114-01.png)

### **2. redo** **日志写入log buffer**

不同的事务可能是`并发`执行的，所以`事务T1`、`事务T2`之间的`mtr`可能是`交替执行`的。

![](./img/2023/07/mysql114-02.png)
...
![](./img/2023/07/mysql114-06.png)

有了Redo Log和Undo Log之后:

![](./img/2023/07/mysql114-07.png)

### **2.** **详细生成过程**

![](./img/2023/07/mysql114-08.png)
...
![](./img/2023/07/mysql114-09.png)

**当我们执行UPDATE时：**

![](./img/2023/07/mysql114-10.png)

```sql
UPDATE user SET id=2 WHERE id=1;
```

![](./img/2023/07/mysql114-11.png)
