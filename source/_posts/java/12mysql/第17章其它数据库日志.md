...
![](./img/2023/08/mysql117-3.png)

使用**两阶段提交**后，写入binlog时发生异常也不会有影响

![](./img/2023/08/mysql117-4.png)

另一个场景，redo log设置commit阶段发生异常，那会不会回滚事务呢？

![](./img/2023/07/mysql117-5.png)
