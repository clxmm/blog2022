...
接下来的两章，咱来介绍关于 IOC 进阶部分，模块装配与条件装配的使用。这一部分相当重要，对于以后学习 SpringBoot 的核心自动装配有巨大的帮助（ SpringBoot 的自动装配，基础就是模块装配 + 条件装配），小伙伴们一定要好好学习这两章呀。
...
[https://docs.spring.io/spring/docs/3.1.0.RELEASE/reference/htmlsingle/](https://docs.spring.io/spring/docs/3.1.0.RELEASE/reference/htmlsingle/)
...
```ini
org.clxmm.configuration.a_module.component.Boss@70beb599
```
...
public class BartenderConfiguration {
    ...
    @Bean
    public Bartender zs() {
        return new Bartender("zs");
    }

    @Bean
    public Bartender ls() {
        return new Bartender("ls");
    }
...
```ini
org.clxmm.configuration.a_module.component.Boss@2b4a2ec7
---------------
...
tavernConfiguration
org.clxmm.configuration.a_module.component.Boss
org.clxmm.configuration.a_module.config.BartenderConfiguration
zs
ls
---------------
zs---org.clxmm.configuration.a_module.component.Bartender@62e136d3
ls---org.clxmm.configuration.a_module.component.Bartender@c8e4bb0
```
...
zs
ls
org.clxmm.configuration.a_module.component.Bar
