---
title: 14. IOC进阶-IOC容器的详细对比-BeanFactory
toc: true
tags: spring
categories: 
    - [java]
...
![](/img/spring/202210/14beanfactory.png)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean class="org.clxmm.container.a_beanfactory.bean.Cat"/>
</beans>
```
...
```ini
加载xml文件后容器中的Bean：
org.clxmm.container.a_beanfactory.bean.Cat#0
```
...
```ini
容器中真的有注册Dog：org.clxmm.container.a_beanfactory.bean.Dog@282ba1e
容器中的所有Dog：[doggg]
```
...
![](/img/spring/202210/14beanfactory01.png)
...
-  什么是 BeanFactory ？BeanFactory 都实现了哪些基础功能？
- 高级 BeanFactory 扩展都有哪些重要特性？
- BeanFactory 的实现类为什么要定义模板方法？目的是什么？
- 最终的 BeanFactory 实现是谁？它都具备哪些特性？