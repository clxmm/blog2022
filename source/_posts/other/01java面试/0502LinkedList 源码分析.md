...
`LinkedList` 是一个基于双向链表实现的集合类，经常被拿来和 `ArrayList` 做比较。关于 `LinkedList` 和`ArrayList`的详细对比，我们 [Java集合常见面试题总结(上)]()有详细介绍到。

<!--more-->

![](./img/2023/10/java-02-bidirectional-linkedlist.png)
...
![](./img/2023/10/java-03-linkedlist--class-diagram.png)
...
可以参考下图理解（图源：[LinkedList 源码分析(JDK 1.8)open in new window](https://www.tianxiaobo.com/2018/01/31/LinkedList-源码分析-JDK-1-8/)）：

![](./img/2023/10/java-04-linkedlist-unlink.jpeg)
