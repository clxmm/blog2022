...
![](./img/2023/10/java-35-executor-class-diagram.png)
...
![](./img/2023/10/java-36-Executor框架的使用示意图-36e59afa.png)
...
![](./img/2023/10/java-37-thread-pool-principle.png)
...
![](./img/2023/10/java-38-FixedThreadPool-f8172448.png)
...
![](./img/2023/10/java-39-SingleThreadExecutor-7ffd92c2.png)
...
![](./img/2023/10/java-40-CachedThreadPool-execute-97103fbe.png)
...
关于定时任务的详细介绍，可以看这篇文章：[Java 定时任务详解open in new window](https://javaguide.cn/system-design/schedule-task.html)

## 线程池最佳实践

[Java 线程池最佳实践open in new window](https://javaguide.cn/java/concurrent/java-thread-pool-best-practices.html)这篇文章总结了一些使用线程池的时候应该注意的东西，实际项目使用线程池之前可以看看。
