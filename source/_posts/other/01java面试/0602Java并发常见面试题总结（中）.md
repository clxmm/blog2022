...
3. 这也就导致两个线程分别对 `inc` 进行了一次自增操作后，`inc` 实际上只增加了 1。
...
![](./img/2023/10/java-21-synchronized-principle.png)
...
![](./img/2023/10/java-22-synchronized关键字原理2.png)
...
### 5.JDK1.6 之后的 synchronized 底层做了哪些优化？
...
![](./img/2023/10/java-23-reentrantlock-class-diagram.png)
...
![](./img/2023/10/java-24-reentrantreadwritelock-class-diagram.png)
