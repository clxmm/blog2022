...
![](./img/2023/09/java-08-java-collection-hierarchy.png)
...
这里简单列举一个例子：假如我们要删除节点9 的话，需要先遍历链表找到该节点。然后，再执行相应节点指针指向的更改，具体的源码可以参考：[LinkedList 源码分析](https://javaguide.cn/java/collection/linkedlist-source-code.html) 。

![](./img/2023/09/java-09-linkedlist-unlink.png)
...
![](./img/2023/09/java-10-bidirectional-linkedlist.png)

**双向循环链表：** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![](./img/2023/09/java-11-bidirectional-circular-linkedlist.png)
