...
![](./img/2023/10/java-09-linkhashmap-structure-overview.png)
...
![](./img/2023/10/java-10-lru-cache.png)
...
![](./img/2023/10/java-11-map-hashmap-linkedhashmap.png)
...
![](./img/2023/10/java-12-linkedhashmap-get.png)

看不太懂也没关系，知道这个方法的作用就够了，后续有时间再慢慢消化。

### 5.remove 方法后置操作——afterNodeRemoval
...
![](./img/2023/10/java-13-linkedhashmap-remove.png)

看不太懂也没关系，知道这个方法的作用就够了，后续有时间再慢慢消化。

###  6.put 方法后置操作——afterNodeInsertion
...
![](./img/2023/10/java-14-linkedhashmap-after-insert-1.png)

移除的步骤很简单，查看链表首节点是否存在，若存在则断开首节点和后继节点的关系，并让首节点指针指向下一节点，所以 head 指针指向了 12，节点 10 成为没有任何引用指向的空对象，等待 GC。

![](./img/2023/10/java-15-linkedhashmap-after-insert-2.png)
